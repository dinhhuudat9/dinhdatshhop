...
class users extends DB
{
    ...
    /**
     * Thêm hoa hồng affiliate
     * @deprecated Sử dụng AffiliateHandler::addCommission() thay thế
     */
    public function AddCommission($ref_id, $user_id, $amount, $reason, $type = 'recharge'){
    ...
    /**
     * Trừ hoa hồng affiliate (khi rút tiền)
     * @deprecated Sử dụng AffiliateHandler::removeCommission() thay thế
     */
    ...
    /**
     * Hoàn trả hoa hồng affiliate
     * @deprecated Sử dụng AffiliateHandler::refundCommission() thay thế
     */
