        ...
        <div class="modal-content">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row mb-4">
                        <label class="col-sm-4 col-form-label" for="example-hf-email"><?=__('Tên cổng thanh toán');?>:
...
document.getElementById('btn-ai-manual')?.addEventListener('click', function(){
    ...
    $.ajax({
        ...
        data: {
            ...
            gateway_title: document.querySelector('input[name="title"]') ? document.querySelector('input[name="title"]').value : ''
        },
