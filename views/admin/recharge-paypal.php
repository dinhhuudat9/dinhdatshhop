...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0"><i class="fa-brands fa-paypal"></i> <?=__('Phương thức thanh toán Paypal');?></h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
...
50|10 (tức nạp $50 khuyến mãi 10%)" name="paypal_promotions"><?=$CMSNT->site('paypal_promotions');?></textarea>
                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        <div class="card-title">
                            <?=__('LỊCH SỬ NẠP TIỀN PAYPAL TỰ ĐỘNG');?>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row row-cols-lg-auto g-3 mb-3">
                                ...
                                <div class="col-lg col-md-4 col-6">
                                    <input type="text" name="time" class="form-control form-control-sm" id="daterange"
                                        value="<?=$time;?>" placeholder="<?=__('Chọn thời gian');?>">
                                </div>
                                <div class="col-12">
