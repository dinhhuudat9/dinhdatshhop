    ...
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0"><a type="button"
                    ...
                    href="<?= base_url_admin('product-api'); ?>"><i class="fa-solid fa-arrow-left"></i></a> <?= __('Chỉnh sửa API nhà cung cấp'); ?> <?= $supplier['domain']; ?>
            </h1>
        </div>
        ...
        ?>
                <div class="alert alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                    ...
                    </a> <?= __('1 phút 1 lần để hệ thống tự động cập nhật dữ liệu từ API.'); ?>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select form-select-lg shadow-sm" id="api-select" name="type" required>
                                                    ...
                                                    <?php foreach ($allApiConfigs as $apiType => $apiConfig): ?>
                                                        <option <?= $supplier['type'] == $apiType ? 'selected' : ''; ?> value="<?= $apiType; ?>" class="bg-success-subtle">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3" id="child_sync" style="display: none;">
                                                ...
                                                <select class="form-select" id="child-select" name="child" required>
                                                    <option <?= (!isset($supplier['child']) || $supplier['child'] == 0) ? 'selected' : ''; ?> value="0"><?= __('OFF - Cấu trúc thông thường (Con → Sản phẩm)'); ?></option>
                                                    <option <?= (isset($supplier['child']) && $supplier['child'] == 1) ? 'selected' : ''; ?> value="1"><?= __('ON - Cấu trúc web con (Cha → Con → Sản phẩm)'); ?></option>
                                                </select>
                                                <div class="form-text">
                                            ...
                                            <div class="col-md-6 mb-3" id="auto_show" style="display: none;">
                                                ...
                                                <select class="form-select" id="auto-show-select" name="isAutoShow" required>
                                                    <option <?= (!isset($supplier['isAutoShow']) || $supplier['isAutoShow'] == 0) ? 'selected' : ''; ?> value="0"><?= __('OFF - Giữ trạng thái ẩn khi đồng bộ'); ?></option>
                                                    <option <?= (isset($supplier['isAutoShow']) && $supplier['isAutoShow'] == 1) ? 'selected' : ''; ?> value="1"><?= __('ON - Tự động hiển thị sản phẩm'); ?></option>
                                                </select>
                                                <div class="form-text">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" id="round-money-select" name="roundMoney" required>
                                                    <option <?= $supplier['roundMoney'] == 'OFF' ? 'selected' : ''; ?> value="OFF"><?= __('OFF - Giữ nguyên số'); ?></option>
                                                    <option <?= $supplier['roundMoney'] == 'ON' ? 'selected' : ''; ?> value="ON"><?= __('ON - Làm tròn số'); ?></option>
                                                </select>
                                                <div class="form-text">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" id="sync-image-select" name="sync_image" required>
                                                    <option <?= (!isset($supplier['sync_image']) || $supplier['sync_image'] == 'ON') ? 'selected' : ''; ?> value="ON"><?= __('ON - Đồng bộ ảnh tự động'); ?></option>
                                                    <option <?= (isset($supplier['sync_image']) && $supplier['sync_image'] == 'OFF') ? 'selected' : ''; ?> value="OFF"><?= __('OFF - Không đồng bộ ảnh'); ?></option>
                                                </select>
                                                <div class="form-text">
...
<script>
    ...
    function removeImageProduct(id, image) {
        cuteAlert({
            ...
            message: "<?= __('Bạn có chắc chắn muốn xóa ảnh'); ?> " + id + " <?= __('không ?'); ?>",
