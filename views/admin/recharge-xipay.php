...
$checkKey = checkAddonLicense($CMSNT->site('gateway_xipay_license'), 'SHOPKEY_GATEWAY_XIPAY');
...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0"><?= __('Cổng thanh toán pay.xipay.cc (AliPay, WeChatPay)'); ?></h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div
                                                ...
                                                <strong><?= __('Chú ý'); ?>:</strong> <?= __('Bạn cần phải mua giấy phép kích hoạt'); ?> <a
                                                    ...
                                                    href="https://client.cmsnt.co/cart.php?a=add&pid=98"><?= __('Addon'); ?></a> <?= __('trước khi sử dụng'); ?>.
                                            </div>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" rows="5" placeholder="100|5 (tức nạp ¥100 khuyến mãi 5%)
500|10 (tức nạp ¥500 khuyến mãi 10%)" name="xipay_promotions"><?= $CMSNT->site('xipay_promotions'); ?></textarea>
