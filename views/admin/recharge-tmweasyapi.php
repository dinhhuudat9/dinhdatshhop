...
$checkKey = checkAddonLicense($CMSNT->site('tmweasyapi_license'), 'SHOPKEY_GATEWAY_tmweasyapi');
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" rows="5" placeholder="100|5 (tức nạp 100 THB khuyến mãi 5%)
500|10 (tức nạp 500 THB khuyến mãi 10%)" name="tmweasyapi_promotions"><?= $CMSNT->site('tmweasyapi_promotions'); ?></textarea>
