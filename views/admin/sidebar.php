...
<?php
if (!function_exists('__cmsnt_sidebar_guard')) {
    function __cmsnt_sidebar_guard(){return;}
}

__cmsnt_sidebar_guard();
?>
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide">
                            <a href="<?= base_url_admin('home'); ?>"
                                ...
                                <i class="bx bxs-dashboard side-menu__icon text-primary"></i>
                                <span class="side-menu__label"><?= __('Dashboard'); ?></span>
                            </a>
                        </li>
                        <li class="slide has-sub <?= show_sidebar(['logs', 'transactions', 'log-auto-bank', 'bot-telegram-logs', 'email-queue', 'telegram-queue']); ?>">
                            <a href="javascript:void(0);"
                                class="side-menu__item <?= show_sidebar(['logs', 'transactions', 'log-auto-bank', 'bot-telegram-logs', 'email-queue', 'telegram-queue']); ?>">
                                <i class='bx bx-history side-menu__icon text-info'></i>
                                ...
                                <?php if (checkPermission($getUser['admin'], 'view_logs') == true): ?>
                                    <li class="slide">
                                        <a href="<?= base_url_admin('email-queue'); ?>"
                                            class="side-menu__item <?= active_sidebar(['email-queue']); ?>">
                                            <?= __('Email Queue'); ?>
                                        </a>
                                    </li>
                                    <li class="slide">
                                        <a href="<?= base_url_admin('telegram-queue'); ?>"
                                            class="side-menu__item <?= active_sidebar(['telegram-queue']); ?>">
                                            <?= __('Telegram Queue'); ?>
                                        </a>
                                    </li>
                                <?php endif ?>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_automations') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('automations'); ?>"
                                    ...
                                    <i class="bx bxs-calendar side-menu__icon text-success"></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_addons') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('addons'); ?>"
                                    ...
                                    <i class="bx bx-plus-circle side-menu__icon text-secondary"></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_block_ip') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('block-ip'); ?>"
                                    ...
                                    <i class="bx bx-block side-menu__icon text-danger"></i>
                                    <span class="side-menu__label"><?= __('Block IP'); ?></span>
                                </a>
                            </li>
                        <?php endif ?>
                        <?php if (checkPermission($getUser['admin'], 'view_media_library') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('media-library'); ?>"
                                    class="side-menu__item <?= active_sidebar(['media-library']); ?>">
                                    <i class="bx bx-images side-menu__icon text-purple"></i>
                                    <span class="side-menu__label"><?= __('Thư viện ảnh'); ?></span>
                                </a>
                            </li>
                        <?php endif ?>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_product') == true): ?>
                            <li
                                class="slide has-sub <?= show_sidebar(['category-add', 'categories', 'category-edit', 'products', 'product-add', 'product-edit', 'product-plans', 'product-plans-all', 'product-stock', 'product-stock-all', 'product-orders', 'product-order-edit', 'product-reviews', 'product-api-edit', 'product-api', 'product-api-add']); ?>">
                                <a href="javascript:void(0);"
                                    class="side-menu__item <?= show_sidebar(['category-add', 'categories', 'category-edit', 'products', 'product-add', 'product-edit', 'product-plans', 'product-plans-all', 'product-stock', 'product-stock-all', 'product-orders', 'product-order-edit', 'product-reviews', 'product-api-edit', 'product-api', 'product-api-add']); ?>">
                                    <i class='bx bx-cart side-menu__icon text-teal'></i>
                                    <span class="side-menu__label"><?= __('SHOPKEY'); ?></span>
                                    <i class="fe fe-chevron-right side-menu__angle"></i>
                                </a>
                                <ul class="slide-menu child1">
                                    <?php if (checkPermission($getUser['admin'], 'view_category') == true): ?>
                                        <li class="slide">
                                            <a href="<?= base_url_admin('categories'); ?>"
                                                class="side-menu__item <?= active_sidebar(['category-add', 'categories', 'category-edit']); ?>"><?= __('Chuyên mục'); ?></a>
                                        </li>
                                    <?php endif ?>
                                    <?php if (checkPermission($getUser['admin'], 'view_product') == true): ?>
                                        <li class="slide">
                                            <a href="<?= base_url_admin('products'); ?>"
                                                class="side-menu__item <?= active_sidebar(['products', 'product-add', 'product-edit', 'product-plans', 'product-stock']); ?>"><?= __('Sản phẩm'); ?></a>
                                        </li>
                                    <?php endif ?>
                                    <?php if (checkPermission($getUser['admin'], 'view_product_plan') == true): ?>
                                        <li class="slide">
                                            <a href="<?= base_url_admin('product-plans-all'); ?>"
                                                class="side-menu__item <?= active_sidebar(['product-plans-all']); ?>"><?= __('Gói sản phẩm'); ?></a>
                                        </li>
                                    <?php endif ?>
                                    <?php if (checkPermission($getUser['admin'], 'view_product_stock') == true): ?>
                                        <li class="slide">
                                            <a href="<?= base_url_admin('product-stock-all'); ?>"
                                                class="side-menu__item <?= active_sidebar(['product-stock-all']); ?>"><?= __('Kho hàng'); ?></a>
                                        </li>
                                    <?php endif ?>
                                    <?php if (checkPermission($getUser['admin'], 'view_orders_product') == true): ?>
                                        <li class="slide">
                                            <a href="<?= base_url_admin('product-orders'); ?>"
                                                class="side-menu__item <?= active_sidebar(['product-orders', 'product-order-edit']); ?>">
                                                <?= __('Đơn hàng'); ?>
                                                <?php
                                                // Đếm số đơn hàng pending
                                                $pending_orders_count = $CMSNT->get_row_safe("SELECT COUNT(id) as total FROM `product_orders` WHERE `status` = 'pending'", []);
                                                $pending_count = $pending_orders_count ? (int)$pending_orders_count['total'] : 0;
                                                ?>
                                                <?php if ($pending_count > 0): ?>
                                                    <span class="badge bg-warning-transparent ms-2"><?= $pending_count; ?></span>
                                                <?php endif; ?>
                                            </a>
                                        </li>
                                    <?php endif ?>
                                    <?php if (checkPermission($getUser['admin'], 'view_product_reviews') == true): ?>
                                        <li class="slide">
                                            <a href="<?= base_url_admin('product-reviews'); ?>"
                                                class="side-menu__item <?= active_sidebar(['product-reviews']); ?>">
                                                <?= __('Đánh giá sản phẩm'); ?>
                                                <?php
                                                // Đếm số đánh giá pending
                                                $pending_reviews_count = $CMSNT->get_row_safe("SELECT COUNT(id) as total FROM `product_reviews` WHERE `status` = 'pending'", []);
                                                $pending_reviews = $pending_reviews_count ? (int)$pending_reviews_count['total'] : 0;
                                                ?>
                                                <?php if ($pending_reviews > 0): ?>
                                                    <span class="badge bg-warning-transparent ms-2"><?= $pending_reviews; ?></span>
                                                <?php endif; ?>
                                            </a>
                                        </li>
                                    <?php endif ?>
                                    <?php if (checkPermission($getUser['admin'], 'manager_suppliers') == true): ?>
                                        <li class="slide">
                                            <a href="<?= base_url_admin('product-api'); ?>"
                                                class="side-menu__item <?= active_sidebar(['product-api-edit', 'product-api', 'product-api-add']); ?>">Kết
                                                nối API</a>
                                        </li>
                                    <?php endif ?>
                                </ul>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_user') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('users'); ?>"
                                    ...
                                    <i class="bx bxs-user side-menu__icon text-info"></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_coupon') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('coupons'); ?>"
                                    class="side-menu__item <?= active_sidebar(['coupons', 'coupon-add', 'coupon-edit']); ?>">
                                    <i class="fa-solid fa-ticket side-menu__icon text-purple"></i>
                                    <span class="side-menu__label"><?= __('Mã giảm giá'); ?></span>
                                </a>
                            </li>
                        <?php endif ?>
                        <?php if (checkPermission($getUser['admin'], 'view_flash_sale') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('flash-sales'); ?>"
                                    class="side-menu__item <?= active_sidebar(['flash-sales', 'flash-sale-add', 'flash-sale-edit']); ?>">
                                    <i class="fa-solid fa-bolt text-warning side-menu__icon"></i>
                                    <span class="side-menu__label"><?= __('Flash Sale'); ?></span>
                                </a>
                            </li>
                        <?php endif ?>
                        <?php if (checkPermission($getUser['admin'], 'view_ticket') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('tickets'); ?>"
                                    ...
                                    <i class="fa-solid fa-headset side-menu__icon text-success"></i>
                                    <span class="side-menu__label"><?= __('Ticket'); ?>
                                        <?php
                                        $total_ticket_pending = $CMSNT->get_row(" SELECT COUNT(id) FROM `support_tickets` WHERE `status` = 'open' ")['COUNT(id)'];
                                        if ($total_ticket_pending > 0): ?>
                                            <span class="badge bg-warning-transparent ms-2"><?= $total_ticket_pending; ?></span>
                                        <?php endif ?>
                                    </span>
                                </a>
                            </li>
                            <li class="slide">
                                <a href="<?= base_url_admin('messages'); ?>"
                                    class="side-menu__item <?= active_sidebar(['messages']); ?>">
                                    <i class="fa-solid fa-message side-menu__icon text-primary"></i>
                                    <span class="side-menu__label"><?= __('Messages'); ?>
                                        <?php
                                        if ($total_ticket_pending > 0): ?>
                                            <span class="badge bg-warning-transparent ms-2"><?= $total_ticket_pending; ?></span>
                                        <?php endif ?>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_role') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('roles'); ?>"
                                    ...
                                    <i class="bx bxs-check-shield side-menu__icon text-orange"></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_recharge') == true): ?>
                            <li
                                class="slide has-sub <?= show_sidebar(['recharge-flutterwave', 'recharge-card', 'recharge-bank', 'recharge-crypto', 'recharge-bank-edit', 'recharge-paypal', 'recharge-perfectmoney', 'recharge-toyyibpay', 'recharge-squadco', 'recharge-bank-config', 'recharge-manual', 'recharge-manual-edit', 'recharge-xipay', 'recharge-korapay', 'recharge-tmweasyapi', 'recharge-bakong', 'recharge-openpix', 'recharge-bank-invoice']); ?>">
                                <a href="javascript:void(0);"
                                    class="side-menu__item <?= active_sidebar(['recharge-flutterwave', 'recharge-card', 'recharge-bank', 'recharge-crypto', 'recharge-bank-edit', 'recharge-paypal', 'recharge-perfectmoney', 'recharge-toyyibpay', 'recharge-squadco', 'recharge-bank-config', 'recharge-manual', 'recharge-manual-edit', 'recharge-xipay', 'recharge-korapay', 'recharge-tmweasyapi', 'recharge-bakong', 'recharge-openpix', 'recharge-bank-invoice']); ?>">
                                    <i class='bx bxs-wallet-alt side-menu__icon text-success'></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_affiliate') == true): ?>
                            <li
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    <i class='bx bx-group side-menu__icon text-pink'></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_email_campaigns') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('email-campaigns'); ?>"
                                    ...
                                    <i class="bx bx-mail-send side-menu__icon text-info"></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_blog') == true): ?>
                            <li
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    <i class='bx bxl-blogger side-menu__icon text-orange'></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_api_keys') == true || checkPermission($getUser['admin'], 'view_api_logs') == true): ?>
                            <li class="slide has-sub <?= show_sidebar(['api-keys', 'api-logs', 'api-key-detail']); ?>">
                                <a href="javascript:void(0);"
                                    class="side-menu__item <?= show_sidebar(['api-keys', 'api-logs', 'api-key-detail']); ?>">
                                    <i class="bx bx-code-alt side-menu__icon text-purple"></i>
                                    <span class="side-menu__label"><?= __('API Management'); ?></span>
                                    <i class="fe fe-chevron-right side-menu__angle"></i>
                                </a>
                                <ul class="slide-menu child1">
                                    <?php if (checkPermission($getUser['admin'], 'view_api_keys') == true): ?>
                                        <li class="slide">
                                            <a href="<?= base_url_admin('api-keys'); ?>"
                                                class="side-menu__item <?= active_sidebar(['api-keys', 'api-key-detail']); ?>"><?= __('API Keys'); ?></a>
                                        </li>
                                    <?php endif ?>
                                    <?php if (checkPermission($getUser['admin'], 'view_api_logs') == true): ?>
                                        <li class="slide">
                                            <a href="<?= base_url_admin('api-logs'); ?>"
                                                class="side-menu__item <?= active_sidebar(['api-logs']); ?>"><?= __('API Logs'); ?></a>
                                        </li>
                                    <?php endif ?>
                                </ul>
                            </li>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_lang') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('language-list'); ?>"
                                    ...
                                    <i class="las la-language side-menu__icon text-teal"></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'view_currency') == true): ?>
                            <li class="slide">
                                <a href="<?= base_url_admin('currency-list'); ?>"
                                    ...
                                    <i class="bx bx-dollar side-menu__icon text-success"></i>
                        ...
                        <?php if (checkPermission($getUser['admin'], 'edit_setting') == true): ?>
                            <li class="slide mb-5">
                                <a href="<?= base_url_admin('settings'); ?>"
                                    ...
                                    <i class="bx bx-cog side-menu__icon text-secondary"></i>
