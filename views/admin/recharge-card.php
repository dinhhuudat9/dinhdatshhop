...
" rows="5" name="list_network_topup_card"><?=$CMSNT->site('list_network_topup_card');?></textarea>
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea class="form-control" rows="5" placeholder="100000|5 (tức nạp thẻ 100,000đ khuyến mãi 5%)
200000|10 (tức nạp thẻ 200,000đ khuyến mãi 10%)" name="card_promotions"><?=$CMSNT->site('card_promotions');?></textarea>
