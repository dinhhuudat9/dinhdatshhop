    ...
    <div class="container-fluid">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h5 class="mb-0"><?= $config['project']; ?> <span class="badge bg-primary"><?= $config['version']; ?></span>
                        ...
                        <a href="<?= base_url('patch.php'); ?>" class="text-decoration-none"><span class="badge bg-danger"
                                style="font-size: 14px; padding: 5px 10px;">Patch Menu</span></a></h5>
                </div>
        ...
        <?php if (DEBUG): ?>
            <div class="alert alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                ...
                Vui lòng tắt <b>DEBUG</b> trong <b>Cài Đặt</b> nếu trong môi trường <b>PRODUCTION</b>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i
                        class="bi bi-x"></i></button>
            </div>
        <?php endif ?>
        ...
        <?php if (!(PHP_MAJOR_VERSION == 8 && PHP_MINOR_VERSION == 4)): ?>
            <div class="alert alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                <svg class="svg-danger" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24"
                    width="1.5rem" fill="#000000">
                    <path d="M0 0h24v24H0z" fill="none" />
                ...
                <strong><?= __('CẢNH BÁO PHIÊN BẢN PHP!'); ?></strong>
                <?= __('Máy chủ hiện đang chạy phiên bản'); ?> <b style="color:red;">PHP <?= PHP_VERSION; ?></b>.
                <?= __('Hệ thống yêu cầu'); ?> <b>PHP 8.4.x</b>. <?= __('Vui lòng chuyển về PHP 8.4 để đảm bảo tương thích và ổn định.'); ?>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i
                        class="bi bi-x"></i></button>
            </div>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if (time() - $CMSNT->site('check_time_cron_telegram_queue') >= 120 && $CMSNT->site('telegram_status') == 1): ?>
            <div class="alert alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                <svg class="svg-danger" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24"
                    width="1.5rem" fill="#000000">
                    <path d="M0 0h24v24H0z" fill="none" />
        ...
        <?php endif; ?>
        <?php if (time() - $CMSNT->site('check_time_cron_email_queue') >= 120 && $CMSNT->site('smtp_status') == 1): ?>
            <div class="alert alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                <svg class="svg-danger" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24"
                    width="1.5rem" fill="#000000">
                    <path d="M0 0h24v24H0z" fill="none" />
        ...
        <div class="row">
            <?php if (checkPermission($getUser['admin'], 'view_statistical') == true): ?>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="card custom-card" style="border-left: 4px solid #f59e0b;">
                        <div class="card-body">
                            <div class="col-6 pe-0">
                                <p class="mb-2">
                                    <span class="fs-16"><?= __('Đơn hàng chờ xử lý'); ?></span>
                                </p>
                                <p class="mb-2 fs-12">
                                    <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0" id="pending_orders_count">
                                        <i class="fas fa-spinner fa-spin spinner-pending" style="display: none;"></i>
                                    </span>
                                </p>
                                <a href="<?= base_url_admin('product-orders&status=pending'); ?>" class="fs-12 mb-0 text-primary"><?= __('Xem tất cả'); ?><i class="ti ti-chevron-right ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Ticket đang chờ phản hồi -->
                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="card custom-card" style="border-left: 4px solid #8b5cf6;">
                        <div class="card-body">
                            <div class="col-6 pe-0">
                                <p class="mb-2">
                                    <span class="fs-16"><?= __('Ticket chờ phản hồi'); ?></span>
                                </p>
                                <p class="mb-2 fs-12">
                                    <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0" id="pending_tickets_count">
                                        <i class="fas fa-spinner fa-spin spinner-pending" style="display: none;"></i>
                                    </span>
                                </p>
                                <a href="<?= base_url_admin('tickets&status=open'); ?>" class="fs-12 mb-0 text-primary"><?= __('Xem tất cả'); ?><i class="ti ti-chevron-right ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="card custom-card" style="border-left: 4px solid #ec4899;">
                        <div class="card-body">
                            <div class="col-6 pe-0">
                                <p class="mb-2">
                                    <span class="fs-16"><?= __('Reviews chờ duyệt'); ?></span>
                                </p>
                                <p class="mb-2 fs-12">
                                    <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0" id="pending_reviews_count">
                                        <i class="fas fa-spinner fa-spin spinner-pending" style="display: none;"></i>
                                    </span>
                                </p>
                                <a href="<?= base_url_admin('product-reviews&status=pending'); ?>" class="fs-12 mb-0 text-primary"><?= __('Xem tất cả'); ?><i class="ti ti-chevron-right ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Rút tiền affiliate chờ duyệt -->
                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="card custom-card" style="border-left: 4px solid #10b981;">
                        <div class="card-body">
                            <div class="col-6 pe-0">
                                <p class="mb-2">
                                    <span class="fs-16"><?= __('Rút tiền chờ duyệt'); ?></span>
                                </p>
                                <p class="mb-2 fs-12">
                                    <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0" id="pending_withdrawals_count">
                                        <i class="fas fa-spinner fa-spin spinner-pending" style="display: none;"></i>
                                    </span>
                                </p>
                                <a href="<?= base_url_admin('affiliate-withdraw&status=pending'); ?>" class="fs-12 mb-0 text-primary"><?= __('Xem tất cả'); ?><i class="ti ti-chevron-right ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Spacer để xuống hàng mới -->
                <div class="col-12"></div>
                <!-- ========================= Kết thúc Widget Cần xử lý ========================= -->
                ...
                <script>
                    ...
                    function show_pending_counts() {
                        $.ajax({
                            ...
                            beforeSend: function() {
                                $('.spinner-pending').show();
                            },
                            success: function(data) {
                                if (data.status === 'success') {
                                    // Cập nhật số đơn hàng pending
                                    $('#pending_orders_count').text(data.pending_orders);
                                    // Cập nhật số ticket chờ phản hồi
                                    $('#pending_tickets_count').text(data.pending_tickets);
                                    // Cập nhật số reviews chờ duyệt
                                    $('#pending_reviews_count').text(data.pending_reviews);
                                    // Cập nhật số yêu cầu rút tiền chờ duyệt
                                    $('#pending_withdrawals_count').text(data.pending_withdrawals);
                                }
                            },
                            complete: function() {
                                $('.spinner-pending').hide();
                            },
                            error: function(xhr, status, error) {
                                console.error('AJAX Error:', error);
                                $('.spinner-pending').hide();
                    ...
                    $(document).ready(function() {
                        ...
                        show_pending_counts(); // Cập nhật số pending ngay khi tải trang
                        setInterval(show_thong_ke_dashboard, 5000); // Cập nhật dữ liệu mỗi 5 giây
                        setInterval(show_pending_counts, 5000); // Cập nhật số pending mỗi 5 giây
                    });
                </script>
            ...
            <?php if (checkPermission($getUser['admin'], 'view_recent_transactions') == true): ?>
                ...
                <div class="col-xl-6">
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title"><?= __('NẠP TIỀN TỰ ĐỘNG GẦN ĐÂY'); ?></div>
                            <div class="ms-auto">
                                <img class="text-right" src="<?= base_url('assets/img/gif-live.gif'); ?>" width="60px">
                            </div>
                        </div>
...
<div class="position-fixed" style="bottom: 80px; right: 20px; z-index: 1000;">
    ...
    <div class="mb-3">
        <button type="button" class="btn btn-success btn-icon rounded-circle shadow-lg" onclick="showTopServices()"
            data-toggle="tooltip" data-placement="left"
            title="<?= __('Top 50 sản phẩm bán chạy nhất hôm nay') ?>">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="suppliersStatsModalLabel">
                    <i class="fas fa-folder-open text-warning me-2"></i><?= __('Thống kê danh mục') ?> <span id="suppliers-date"></span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="max-height: 600px; overflow-y: auto;">
                <div id="suppliers-loading" class="text-center py-4" style="display: none;">
                    ...
                    <div class="mt-2"><?= __('Đang tải thống kê danh mục...') ?></div>
                </div>

                <div class="alert alert-warning d-flex align-items-center mb-3" role="alert">
                    <i class="fas fa-info-circle me-2"></i>
                    <div>
                        <strong><?= __('Thống kê danh mục sản phẩm hôm nay') ?></strong><br />
                    ...
                    <table class="table table-striped table-hover table-sm">
                        <thead class="table-warning sticky-top">
                            <tr>
                                ...
                                <th style="width: 320px;"><?= __('Danh mục') ?></th>
                ...
                <div id="suppliers-empty" class="text-center py-4" style="display: none;">
                    ...
                    <p class="text-muted"><?= __('Chưa có đơn hàng nào trong ngày hôm nay') ?></p>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="topServicesModalLabel">
                    <i class="fas fa-chart-bar text-success me-2"></i><?= __('Top sản phẩm bán chạy nhất') ?> <span id="services-date"></span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="max-height: 600px; overflow-y: auto;">
                <div id="services-loading" class="text-center py-4" style="display: none;">
                    ...
                    <div class="mt-2"><?= __('Đang tải danh sách sản phẩm...') ?></div>
                </div>

                <div class="alert alert-success d-flex align-items-center mb-3" role="alert">
                    <i class="fas fa-info-circle me-2"></i>
                    <div>
                        <strong><?= __('Top 50 sản phẩm có doanh thu cao nhất hôm nay') ?></strong><br />
                ...
                <div id="services-content" class="table-responsive">
                    <table class="table table-striped table-hover table-sm">
                        <thead class="table-success sticky-top">
                            <tr>
                                <th class="text-center" style="width: 60px;"><?= __('Hạng') ?></th>
                                <th style="width: 320px;"><?= __('ID - Tên sản phẩm') ?></th>
                                <th class="text-end" style="width: 120px;"><?= __('Doanh thu') ?></th>
                                <th class="text-end" style="width: 120px;"><?= __('Chi phí') ?></th>
                                <th class="text-end" style="width: 120px;"><?= __('Lợi nhuận') ?></th>
                                <th class="text-center" style="width: 100px;"><?= __('Số đơn') ?></th>
                ...
                <div id="services-empty" class="text-center py-4" style="display: none;">
                    ...
                    <p class="text-muted"><?= __('Chưa có sản phẩm nào được bán trong ngày hôm nay') ?></p>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                    ...
                    if (response.data.length > 0) {
                        ...
                        response.data.forEach(function(supplier) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <a href="<?= base_url_admin('products&category_id=') ?>${supplier.supplier_id}" 
                                           class="text-decoration-none fw-bold text-primary" data-toggle="tooltip" data-placement="left"
                                           title="<?= __('Xem sản phẩm trong danh mục') ?>">
                    ...
                    if (response.data.length > 0) {
                        ...
                        response.data.forEach(function(service) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <a href="<?= base_url_admin('product-edit&id=') ?>${service.service_id}" 
                                           class="text-decoration-none fw-bold text-primary"  data-toggle="tooltip" data-placement="left"
