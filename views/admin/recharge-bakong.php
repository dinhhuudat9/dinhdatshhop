...
$checkKey = checkAddonLicense($CMSNT->site('bakong_license'), 'SHOPKEY_GATEWAY_bakong');
...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0"><?= __('Phương thức thanh toán Bakong Wallet Cambodia'); ?></h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div
                                                ...
                                                <strong><?= __('Chú ý:'); ?></strong> <?= __('Bạn cần phải mua giấy phép kích hoạt'); ?> <a
                                                    ...
                                                    href="https://client.cmsnt.co/cart.php?a=add&pid=88"><?= __('Addon'); ?></a> <?= __('trước khi sử dụng.'); ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div class="col-lg-12 col-xl-6">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <small><?= __('Thông tin Profile ID có thể tìm thấy tại'); ?> <a href="https://raksmeypay.com/configuration" class="text-primary" target="_blank"><?= __('đây'); ?></a></small>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <small><?= __('Thông tin Profile Key có thể tìm thấy tại'); ?> <a href="https://raksmeypay.com/configuration" class="text-primary" target="_blank"><?= __('đây'); ?></a></small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="row mb-4">
                                            <label class="col-sm-6 col-form-label" for="example-hf-email"><?= __('Khuyến mãi nạp tiền nếu có'); ?></label>
                                            <div class="col-sm-6">
                                                <textarea class="form-control" rows="5" placeholder="10|5 (tức nạp $10 khuyến mãi 5%)
50|10 (tức nạp $50 khuyến mãi 10%)" name="bakong_promotions"><?= $CMSNT->site('bakong_promotions'); ?></textarea>
                                                <small><?= __('Nhập mốc nạp khuyến mãi nạp tiền nếu có, mỗi dòng là một mốc nạp.'); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-xl-12">
