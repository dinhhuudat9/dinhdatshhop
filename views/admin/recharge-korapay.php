...
$checkKey = checkAddonLicense($CMSNT->site('korapay_license'), 'SHOPKEY_GATEWAY_KORAPAY');
...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0"><?= __('Phương thức thanh toán Korapay'); ?></h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div
                                                ...
                                                <strong><?= __('Chú ý'); ?>:</strong> <?= __('Bạn cần phải mua giấy phép kích hoạt'); ?> <a
                                                    ...
                                                    href="https://client.cmsnt.co/cart.php?a=add&pid=99"><?= __('Addon'); ?></a> <?= __('trước khi sử dụng'); ?>.
                                            </div>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" rows="5" placeholder="1000|5 (tức nạp 1000 khuyến mãi 5%)
5000|10 (tức nạp 5000 khuyến mãi 10%)" name="korapay_promotions"><?= $CMSNT->site('korapay_promotions'); ?></textarea>
