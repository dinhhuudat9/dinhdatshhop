...
<div class="breadcrumb-header">
    <div class="container">
        <nav class="breadcrumb-modern" aria-label="breadcrumb">
            ...
            <span class="breadcrumb-item active"><?= __('Recharge Bakong'); ?></span>
        </nav>
    </div>
</div>
<?php
...
<section class="py-5 inner-section profile-part">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="card-modern">
                    <div class="card-modern-header">
                        <h5><?= __('Recharge Bakong Wallet Cambodia'); ?></h5>
                    </div>
            ...
            <div class="col-md-5">
                <?php
                $bakongPromotions = parseCryptoPromotionsConfig($CMSNT->site('bakong_promotions'));
                ?>
                <?php if (!empty($bakongPromotions)): ?>
                    <div class="card-modern mb-3">
                        ...
                        <div class="card-modern-body">
                            <table class="table fs-sm mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($bakongPromotions as $promotion):
            ...
            <div class="col-md-12">
                <div class="card-modern">
                    <div class="card-modern-header">
                        <h5><?= __('Lịch sử nạp Bakong Wallet Cambodia'); ?></h5>
                    </div>
                    <div class="card-modern-body">
